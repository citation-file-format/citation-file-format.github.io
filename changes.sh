...
git log --boundary --no-merges --pretty=format:'- [%s](http://github.com/citation-file-format/citation-file-format.github.io/commit/%H)' --reverse src..HEAD | grep -v Merge > 1.0.3-4-changes.md
